...
if (isset($_POST["id"])){
    ...
    $comentarios = $_POST["comentarios"];
        ...
        //hacemos un query de update para actualizar el registro
        include "conexion.php";

        $sql= "update martin_directorio set nombre='$nombre', apellido='$apellido', empresa='$empresa', email='$email', telefono='$telefono',
        comentarios='$comentarios', where idDirectorio = ".$id;
